...
public class MorphingSteelSwordItem extends SwordItem {

    private final CycledTraitHandler cycledTraitHandler = new CycledTraitHandler();
    private final Set<String> ALL_POTENTIAL_TRAITS = ImmutableSet.of(cycledTraitHandler.DEADLY, cycledTraitHandler.SILKY, cycledTraitHandler.LUCKY, cycledTraitHandler.INCENDIARY);

    private final int capacity = 3400;
    private final int maxReceive = 10;
    private final int maxExtract = maxReceive;

    public MorphingSteelSwordItem() {
        super(
        ...
        setRegistryName(NeoArsenal.MOD_ID, "morphing_steel_sword");

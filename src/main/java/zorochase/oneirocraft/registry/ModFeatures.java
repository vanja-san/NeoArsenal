...
public class ModFeatures {
    ...
    public static Feature<NoFeatureConfig> ONEIRIC_BERRY_BUSH_FEATURE;

    public static <V extends R, R extends IForgeRegistryEntry<R>> V register(IForgeRegistry<R> registry, V feature, String name) {
        feature.setRegistryName(new ResourceLocation(Oneirocraft.MOD_ID, name));
    ...
    public static void addFeatures() {
        for (Biome biome : ForgeRegistries.BIOMES) {
            if (
                ...
                biome.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Biome.createDecoratedFeature(ONEIRIC_BERRY_BUSH_FEATURE, IFeatureConfig.NO_FEATURE_CONFIG, Placement.COUNT_HEIGHTMAP_DOUBLE, new FrequencyConfig(1)));
            }
        }
    }
}
